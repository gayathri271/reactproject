...
//                     <Form.Control type="text" name="name" onChange={handleDetails} ></Form.Control>
//                     </Form.Group>
//                     <Form.Group>
//                     <Form.Label>Email</Form.Label>
//                     <Form.Control type="email" name="email" onChange={handleDetails}></Form.Control>
//                     </Form.Group>
//                    <Form.Group>
//                    <Form.Label>Password</Form.Label>
//                    <Form.Control type="password" name="password" onChange={handleDetails}></Form.Control>
//                    </Form.Group>
